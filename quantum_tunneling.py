...
print('')
V0_in = float(input('Enter the barrier height in eV (try 600): ') or 600)
bw_in = float(input('Enter the barrier width in Angstrom (try 0.25): ') or 0.25)
ke_in = float(input('Enter the electron energy in eV (try 500): ') or 500)
sig_in = float(input('Enter the initial electron wavefunction spread in Angstrom (try 0.8): ') or 0.8)
